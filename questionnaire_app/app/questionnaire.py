...
POSTTEST_SECTIONS = [
    {
        "id": "mindset",
        "title": {"en": "AI Coding Agent Supervision Mindset", "zh": "人工智能编程智能体(AI coding agent)监督意识"},
        "question_ids": [
...
POSTTEST_QUESTIONS = [
    {
        ...
        "section": "mindset",
        "prompt": {
            "en": "When reviewing code generated by an AI coding agent, I see my role as a human supervisor rather than simply accepting the agent output.",
            "zh": "看到人工智能编程智能体(AI coding agent)给出的代码(code)时，我认为自己是人工监督者(human supervisor)，应该负责检查它，而不是直接接受。",
        },
    },
    {
        ...
        "section": "mindset",
        "prompt": {
            "en": "When evaluating an AI coding agent's output, I first check whether it follows all task requirements.",
    ...
    },
    {
        ...
        "section": "mindset",
        "prompt": {
            "en": "I pay attention to whether the AI coding agent has missed important conditions, constraints, or edge cases in the task.",
    ...
    },
    {
        ...
        "section": "mindset",
        "prompt": {
            "en": "I trace the actual logic of code generated by an AI coding agent rather than only judging whether it looks reasonable.",
    ...
    },
    {
        ...
        "section": "mindset",
        "prompt": {
            "en": "I try to predict the output of the AI coding agent's code for specific inputs to find possible errors.",
    ...
    },
    {
        ...
        "section": "mindset",
        "prompt": {
            "en": "I design test cases or counterexamples to check whether the AI coding agent's code is correct.",
            "zh": "我会设计测试用例(test case)或反例，检查人工智能编程智能体(AI coding agent)给出的代码(code)是否真的正确。",
        },
    },
    {
        ...
        "prompt": {
            "en": "I can judge when an AI coding agent's output needs human correction or intervention.",
            "zh": "我能判断什么时候需要人工修改或介入人工智能编程智能体(AI coding agent)给出的代码(code)。",
        },
    },
    {
        ...
        "section": "responsibility",
        "prompt": {
            "en": "Before approving an AI coding agent's output for delivery, I consider possible risks and my responsibility as the human supervisor.",
            "zh": "交付人工智能编程智能体(AI coding agent)给出的代码(code)前，我会考虑可能的风险，以及自己作为人工监督者(human supervisor)需要承担的检查责任。",
        },
    },
]
    ...
    return round(subtotal + shipping, 2)""",
        "supervision_card": [
            ...
            },
            {
                ...
                "dimension": "Agent Code Understanding",
                "prompt": "Does price_table.get(pid, 0) treat an unknown product as price 0?",
                "options": ["Yes", "No", "Not sure"],
            },
            {
                "id": "T1_SC_output_debugging",
                "dimension": "Agent Output Debugging",
                "prompt": 'For items={"A":2,"X":1}, will X be silently ignored by the agent-generated code?',
                "options": ["Yes", "No", "Not sure"],
            },
            {
...
C_TASKS = [
    ...
    return count;
        ...
        "supervision_card": [
            ...
            {"id": "T2_SC_code_understanding", "dimension": "Agent Code Understanding", "prompt": 'Can strcmp(line, "") skip a blank line read as "\\n"?', "options": ["Can", "Cannot", "Not sure"]},
            {"id": "T2_SC_output_debugging", "dimension": "Agent Output Debugging", "prompt": "Will the code append to old output instead of overwriting it?", "options": ["Yes", "No", "Not sure"]},
...
ZH_TASK_TEXT = {
    1: {
        ...
        "questions": {
            "Q1": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q2": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q3": "这份人工智能编程智能体(AI coding agent)给出的代码(code)实际会返回什么？",
        ...
        "supervision": {
            ...
            "T1_SC_output_debugging": '对 items={"A":2,"X":1}，未知商品 X 是否会被这份人工智能编程智能体(AI coding agent)给出的代码(code)悄悄忽略？',
    ...
    2: {
        ...
        "questions": {
            "Q6": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q7": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q8": "这份人工智能编程智能体(AI coding agent)给出的代码(code)最可能发生什么？",
    ...
    3: {
        ...
        "questions": {
            "Q11": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q12": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q13": "这份人工智能编程智能体(AI coding agent)给出的代码(code)会返回什么？",
    ...
    4: {
        ...
        "questions": {
            "Q16": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q17": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q18": "这份人工智能编程智能体(AI coding agent)给出的代码(code)最可能返回什么？",
    ...
    5: {
        ...
        "questions": {
            "Q21": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q22": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q23": "这份人工智能编程智能体(AI coding agent)给出的代码(code)会返回什么？",
    ...
    6: {
        ...
        "questions": {
            "Q26": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q27": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q28": "这份人工智能编程智能体(AI coding agent)给出的代码(code)会返回什么？",
...
C_ZH_TASK_TEXT = {
    1: {
        ...
        "questions": {
            "Q1": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q2": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q3": "这份人工智能编程智能体(AI coding agent)给出的代码(code)会返回什么？",
    ...
    2: {
        ...
        "questions": {
            "Q6": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q7": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q8": "这份人工智能编程智能体(AI coding agent)给出的代码(code)会返回什么？",
    ...
    3: {
        ...
        "questions": {
            "Q11": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q12": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q13": "这份人工智能编程智能体(AI coding agent)给出的代码(code)会生成什么结果？",
    ...
    4: {
        ...
        "questions": {
            "Q16": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q17": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q18": "按普通 C 语言整数除法规则，这份人工智能编程智能体(AI coding agent)给出的代码(code)会返回什么？",
    ...
    5: {
        ...
        "questions": {
            "Q21": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q22": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q23": "这份人工智能编程智能体(AI coding agent)给出的代码(code)会生成哪些 totals？",
    ...
    6: {
        ...
        "questions": {
            "Q26": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
            "Q27": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
            "Q28": "这份人工智能编程智能体(AI coding agent)给出的代码(code)会生成哪些 totals？",
...
CODE_TASK_QUESTION_CONTEXT_ZH = {
    "Q1": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
    "Q2": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
    "Q3": "这份人工智能编程智能体(AI coding agent)给出的代码(code)实际会返回什么？",
    "Q4": "根据任务要求，上述输入的正确返回值应该是什么？",
    "Q5": "这份人工智能编程智能体(AI coding agent)给出的代码(code)中，最需要发现的隐藏错误是什么？",
    "Q6": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
    "Q7": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
    "Q8": "这份人工智能编程智能体(AI coding agent)给出的代码(code)最可能发生什么？",
    "Q9": "根据任务要求，上述输入的正确返回结果应该是什么？",
    "Q10": "这份人工智能编程智能体(AI coding agent)给出的代码(code)中，最需要发现的隐藏问题包括哪一组？",
    "Q11": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
    "Q12": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
    "Q13": "这份人工智能编程智能体(AI coding agent)给出的代码(code)会返回什么？",
    "Q14": "根据任务要求，上述输入的正确结果应该是什么？",
    "Q15": "这份人工智能编程智能体(AI coding agent)给出的代码(code)中，最需要发现的隐藏错误是什么？",
    "Q16": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
    "Q17": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
    "Q18": "这份人工智能编程智能体(AI coding agent)给出的代码(code)最可能返回什么？",
    "Q19": "根据任务要求，上述输入的正确返回值应该是什么？",
    "Q20": "这份人工智能编程智能体(AI coding agent)给出的代码(code)中，最需要发现的隐藏错误是什么？",
    "Q21": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
    "Q22": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
    "Q23": "这份人工智能编程智能体(AI coding agent)给出的代码(code)会返回什么？",
    "Q24": "根据任务要求，上述输入的正确结果应该是什么？",
    "Q25": "这份人工智能编程智能体(AI coding agent)给出的代码(code)中，最需要发现的隐藏错误是什么？",
    "Q26": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否完全满足任务要求？",
    "Q27": "这份人工智能编程智能体(AI coding agent)给出的代码(code)是否可以直接交付？",
    "Q28": "这份人工智能编程智能体(AI coding agent)给出的代码(code)会返回什么？",
    "Q29": "根据任务要求，上述输入的正确结果应该是什么？",
    "Q30": "这份人工智能编程智能体(AI coding agent)给出的代码(code)中，最需要发现的隐藏问题包括哪一组？",
}
...
AGENT_TASK_QUESTION_CONTEXT_ZH = {
    "Q1": "作为人工监督者(human supervisor)，你认为智能体(agent)最后说“测试通过”是否有运行记录支持？",
    "Q2": "该智能体(agent)在交付前，是否真的验证了“未知商品编号应被处理”这个要求？",
    "Q3": "该智能体(agent)交付的代码(code)是否符合用户目标？",
    "Q4": "作为人工监督者(human supervisor)，如果 ids={1,9} 且 9 是未知商品编号，正确实现应该返回什么？",
    "Q5": "人工监督者(human supervisor)最需要发现的隐藏交付问题是什么？",
    "Q6": "作为人工监督者(human supervisor)，你认为智能体(agent)说“测试通过”是否有观察结果支持？",
    "Q7": "该智能体(agent)在交付前，是否完成了“覆盖写入”这个要求？",
    "Q8": "对于输入 \"a\\n\\nb\\n\"，运行记录里智能体(agent)的代码(code)输出了什么？",
    "Q9": "作为人工监督者(human supervisor)，根据用户目标，正确计数应该是多少？",
    ...
    "Q11": "作为人工监督者(human supervisor)，你认为智能体(agent)的结论是否有观察结果支持？",
    "Q12": "作为人工监督者(human supervisor)，你认为这个智能体(agent)交付结果是否可以直接交付？",
    "Q13": "该智能体(agent)的运行记录显示了什么？",
    "Q14": "作为人工监督者(human supervisor)，根据用户目标，Bob 缺失成绩时应该怎样处理？",
    "Q15": "作为人工监督者(human supervisor)，最合适的交付监督决定是什么？",
    "Q16": "作为人工监督者(human supervisor)，你认为智能体(agent)最后的结论是否有测试观察结果支持？",
    "Q17": "该智能体(agent)在交付前，是否实现了“忽略 -1”这个要求？",
    "Q18": "对于 arr={2,4,-1}，智能体(agent)的代码(code)输出了什么？",
    "Q19": "作为人工监督者(human supervisor)，根据用户目标，正确平均数应该是多少？",
    "Q20": "作为人工监督者(human supervisor)，你下一步应该要求什么进一步测试或修改？",
    "Q21": "作为人工监督者(human supervisor)，你认为智能体(agent)最后的说法是否有运行流程支持？",
    "Q22": "作为人工监督者(human supervisor)，你认为这个智能体(agent)交付结果是否可以直接交付？",
    "Q23": "对于 prices={10,20,5}, qty={2,1,4}, cat={0,1,0}，运行记录中观察到的 totals 是什么？",
    "Q24": "作为人工监督者(human supervisor)，根据用户目标，totals 应该是什么？",
    "Q25": "作为人工监督者(human supervisor)，最合适的交付监督决定是什么？",
    "Q26": "作为人工监督者(human supervisor)，你认为智能体(agent)最后的结论是否完全有运行流程支持？",
    "Q27": "作为人工监督者(human supervisor)，你认为这个智能体(agent)交付结果是否可以直接交付？",
    "Q28": "对于 1,2,10 和 2,3,5 这两行，智能体(agent)的代码(code)生成了哪些 totals？",
    "Q29": "作为人工监督者(human supervisor)，根据用户目标，这两行的正确 totals 应该是什么？",
...
def apply_chinese_task_question_context(task: dict, version: str) -> None:
    prompt_map = AGENT_TASK_QUESTION_CONTEXT_ZH if version == "agent" else CODE_TASK_QUESTION_CONTEXT_ZH
    for question in task["questions"]:
        if question["id"] in prompt_map:
            question["prompt"] = prompt_map[question["id"]]
...
def localized_task(task_id: int, lang: str = "en", version: str = "python") -> dict:
    ...
    if normalized_version == "agent":
        ...
        apply_chinese_task_question_context(task, normalized_version)
        ...
        if task.get("supervision_card"):
            for item in task["supervision_card"]:
                ...
                item["dimension"] = {
                    ...
                    "Agent Code Understanding": "理解智能体(agent)生成的代码(code)",
                    "Agent Output Debugging": "核对智能体(agent)输出",
...
def posttest_schema(lang: str = "en") -> dict:
    ...
    return {
        "title": "AI coding agent 交付监督能力后测" if language == "zh" else "AI Coding Agent Supervision Competence Post-test",
        "intro": (
            "请根据完成全部任务后的真实感受作答。这里想了解你是否形成了作为人工监督者(human supervisor)监督人工智能编程智能体(AI coding agent)交付结果的意识、方法和责任判断。结束后小问卷不计入正式任务得分。"
            if language == "zh"
            else "Please answer based on your experience after completing all tasks. This post-test measures your mindset, strategies, and responsibility judgments as a human supervisor reviewing AI coding agent outputs. It is not included in the formal task score."
        ),
        "sections": [
