...
const i18n = {
  ...
  zh: {
    switchLabel: "English",
    eyebrow: "研究问卷",
    title: "人工智能(AI)代码监督能力研究",
    pretest: "前测",
    pretestTitle: "开始前的小问卷",
    pretestHint: "请先填写基本信息。系统会自动生成参与者 ID，你不需要手动填写。",
    introTitle: "欢迎参加人工智能(AI)代码监督研究",
    introPurpose: "你要做的不是写代码，而是像审核人一样检查人工智能(AI)或智能体(agent)交出的结果：它有没有按要求完成、有没有藏着错误、能不能放心交付。",
    introSections: [
      {
        title: "你需要做什么？",
        body: "你会先填写基本信息，然后查看 6 份由人工智能(AI)或智能体(agent)给出的代码(code)结果，最后完成一份很短的感受问卷。",
      },
      {
        title: "怎么判断？",
        body: "先看任务要求，再看代码(code)或智能体(agent)的运行记录。请按你自己的判断选择最合适的答案。",
      },
    ],
    introContinue: "进入前测",
    ...
    noticeSections: [
      {
        title: "这项研究在看什么？",
        body: "本问卷关注你能否监督人工智能(AI)或智能体(agent)的代码(code)结果：看懂任务、核对过程、发现问题，并判断是否能交付。",
      },
      {
        title: "你会经历哪些步骤？",
    ...
    taskGuideSteps: [
      "先看任务要求：它说明正确结果应该做到什么。",
      "如果页面显示代码(code)，请判断这段代码实际会做什么；如果页面显示智能体(agent)运行流程，请判断它的操作和结论是否对得上。",
      "遇到“代码会返回什么”时，按代码(code)实际行为回答；遇到“正确结果应该是什么”时，按任务要求回答。",
      "最后判断这份人工智能(AI)或智能体(agent)的结果是否满足要求，以及是否可以直接交付。",
    ],
    taskSectionLabels: {
      requirements: "任务要求",
      aiCode: "人工智能(AI)生成的代码(code)",
      agentTrace: "智能体(agent)运行流程 / Agent运行流程",
      questions: "正式问题",
      givenInput: "给定输入",
    },
    supervisionCard: "监督检查卡",
    supervisionIntro: "这张卡帮助你一步步检查人工智能(AI)或智能体(agent)的结果。请按自己的判断填写，它不是答案提示。",
    submitTask: "提交本任务",
    submitAll: "提交问卷",
